...
government_expenditure_on_education = org_df[['country', 'year', 'government_expenditure_on_education']].dropna()
...
for i, year in enumerate(years_to_plot):
    ...
    plt.bar(np.arange(data.shape[0]) + (0.2 * i), data['government_expenditure_on_education'], color=selected_colors[i], width=barWidth, label=str(year))
...
for i, year in enumerate(years_to_plot):
    ...
    plt.bar(np.arange(data.shape[0]) + (0.2 * i), data['forest_area'], color=selected_colors[i], width=barWidth, label=str(year))
